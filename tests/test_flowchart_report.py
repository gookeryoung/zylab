"""flowchart.report DSL 报告生成器测试：Markdown/HTML 双载体 + SVG 曲线内嵌."""
...
def test_curve_log_axis_and_peak_svg() -> None:
    ...
    from zylab.flowchart.report import _curve_svg
...
def test_table_column_format_and_align_in_html_and_md() -> None:
    ...
    from zylab.flowchart.report import _html_view, _md_view
...
def test_markdown_text_rendered_in_html_report() -> None:
    ...
    from zylab.flowchart.report import _html_view, _md_view
    from zylab.flowchart.results import TextData
...
def test_table_default_format_when_not_specified() -> None:
    ...
    from zylab.flowchart.report import _fmt_with_col
    from zylab.flowchart.results import TableColumn
...
def test_markdown_text_style_field_preserved_in_html() -> None:
    ...
    from zylab.flowchart.report import _html_view
    from zylab.flowchart.results import TextData
...
def test_fmt_non_float_passthrough() -> None:
    ...
    from zylab.flowchart.report import _fmt
