"""flowchart.meshing3d 三维网格生成与 3D 电阻建模节点测试：规模/雅可比/解析验证/瞬态节点."""
...
from zylab.flowchart import BUILTIN_TEMPLATES, module_spec, nodes
from zylab.flowchart.meshing3d import cylinder_resistor_mesh, vfilm_resistor_mesh
