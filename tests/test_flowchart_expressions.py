"""flowchart.expressions 表达式安全求值测试 + DSL 派生参数求值集成测试."""
...
from zylab.flowchart.expressions import SAFE_MATH_NAMESPACE, expr_names, safe_eval
...
def test_safe_eval_array_aggregates() -> None:
    ...
    from zylab.flowchart.expressions import ARRAY_MATH_NAMESPACE
