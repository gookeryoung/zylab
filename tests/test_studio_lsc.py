...
from zylab.studio.lsc import LSCCurve, solve_lsc_curve
from zylab.studio.module import module_spec
from zylab.studio.nodes import run_lsc_curve
...
def test_compute_lsc_curve_registered() -> None:
    ...
    assert spec.target == "zylab.studio.nodes:run_lsc_curve"
...
def test_dsl_lsc_curve_template() -> None:
    ...
    from zylab.studio.batch import run_workflow
    from zylab.studio.builtin import BUILTIN_TEMPLATES
