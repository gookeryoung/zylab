"""flowchart.nodes 节点执行函数测试：源节点建模、分析节点求解、内置模板端到端可执行."""
...
from zylab.flowchart import BUILTIN_TEMPLATES, ModelBundle, module_spec, nodes
...
class TestRunAnalyses:
    ...
    def test_param_validation_flows_through(self) -> None:
        ...
        from zylab.flowchart import ParamError
