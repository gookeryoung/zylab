"""flowchart compute/post 节点测试：公式计算、参数扫参、静力结果提取 + DSL 集成."""
...
from zylab.flowchart.errors import FlowchartError, ParamError, TemplateError
from zylab.flowchart.module import ParamSpec, ParamType, module_spec
from zylab.flowchart.nodes import build_cantilever, compute_expr, compute_sweep, post_static, run_static
...
def test_compute_sweep_body_validation() -> None:
    ...
    with pytest.raises(FlowchartError, match="missing"):
