...
BUILTIN_MODULES: tuple[ModuleSpec, ...] = (
    ModuleSpec(
        ...
        target="zylab.flowchart.nodes:build_cantilever",
    ...
    ModuleSpec(
        ...
        name="悬臂柱（BEAM2）",
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:build_column",
        outputs=(PortSpec("model", PortType.MODEL, "模型"),),
        params=(
    ...
    ModuleSpec(
        ...
        name="两杆浅桁架（TRUSS2）",
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:build_truss",
        outputs=(PortSpec("model", PortType.MODEL, "模型"),),
        params=(
    ...
    ModuleSpec(
        ...
        target="zylab.flowchart.nodes:run_static",
    ...
    ModuleSpec(
        ...
        name="模态分析",
        category=ModuleCategory.ANALYSIS,
        target="zylab.flowchart.nodes:run_modal",
        inputs=(PortSpec("model", PortType.MODEL, "模型"),),
    ...
    ModuleSpec(
        ...
        name="谐响应分析",
        category=ModuleCategory.ANALYSIS,
        target="zylab.flowchart.nodes:run_harmonic",
        inputs=(PortSpec("model", PortType.MODEL, "模型"),),
    ...
    ModuleSpec(
        ...
        name="瞬态动力分析",
        category=ModuleCategory.ANALYSIS,
        target="zylab.flowchart.nodes:run_transient",
        inputs=(PortSpec("model", PortType.MODEL, "模型"),),
    ...
    ModuleSpec(
        ...
        name="屈曲分析",
        category=ModuleCategory.ANALYSIS,
        target="zylab.flowchart.nodes:run_buckling",
        inputs=(
    ...
    ModuleSpec(
        ...
        name="通电加热板（Q4 电-热耦合）",
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:build_joule_plate",
    ...
    ModuleSpec(
        ...
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:build_joule_series",
        outputs=(PortSpec("model", PortType.ET_MODEL, "传导模型"),),
        params=(
    ...
    ModuleSpec(
        ...
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:build_joule_hole",
        outputs=(PortSpec("model", PortType.ET_MODEL, "传导模型"),),
        params=(
            ParamSpec("length", "板总长 L", ParamType.FLOAT, 30.0, 0.3, 1.0e4, 1.0, "mm"),
            ParamSpec("height", "板高 H", ParamType.FLOAT, 10.0, 0.1, 1.0e4, 1.0, "mm"),
    ...
    ModuleSpec(
        ...
        name="电-热耦合分析",
        category=ModuleCategory.ANALYSIS,
        target="zylab.flowchart.nodes:run_electrothermal",
    ...
    ModuleSpec(
        ...
        name="瞬态电-热耦合分析",
        category=ModuleCategory.ANALYSIS,
        target="zylab.flowchart.nodes:run_electrothermal_transient",
        inputs=(PortSpec("model", PortType.ET_MODEL, "传导模型"),),
    ...
    ModuleSpec(
        ...
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:build_cylinder_resistor",
        outputs=(PortSpec("model", PortType.ET_MODEL, "传导模型"),),
        params=(
    ...
    ModuleSpec(
        ...
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:build_vfilm_resistor",
        outputs=(PortSpec("model", PortType.ET_MODEL, "传导模型"),),
        params=(
    ...
    ModuleSpec(
        ...
        name="几何非线性分析",
        category=ModuleCategory.ANALYSIS,
        target="zylab.flowchart.nodes:run_nonlinear",
        inputs=(
            PortSpec("model", PortType.MODEL, "模型"),
    ...
    ModuleSpec(
        ...
        target="zylab.flowchart.nodes:compute_expr",
    ...
    ModuleSpec(
        ...
        name="参数扫描",
        category=ModuleCategory.POST,
        target="zylab.flowchart.nodes:compute_sweep",
        outputs=(PortSpec("data", PortType.DATA, "数据"),),
        params=(
    ...
    ModuleSpec(
        ...
        name="静力结果提取",
        category=ModuleCategory.POST,
        target="zylab.flowchart.nodes:post_static",
    ...
    ModuleSpec(
        ...
        name="感度试验统计",
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:run_sensitivity_test_node",
        ...
        params=(
            ParamSpec(
                ...
                ParamType.STR,
                "langlie",
                doc="方法名: langlie(101)/ostr(102)/updown(103)/updown_adaptive(103自适应)/doptimal(104)/neyer/probit(201)/stepstress(202)",
            ),
            ParamSpec(
                "model",
                "响应模型",
    ...
    ModuleSpec(
        ...
        name="升降法实测分析",
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:analyze_updown_records_node",
        outputs=(PortSpec("data", PortType.DATA, "试验结果"),),
        params=(
            ParamSpec(
                "records",
    ...
    ModuleSpec(
        ...
        name="LSC 曲线优化",
        category=ModuleCategory.SOURCE,
        target="zylab.flowchart.nodes:run_lsc_curve",
