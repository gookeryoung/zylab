...
from zylab.fea import Constraint, ElementBlock, ElementType, LinearElastic, Mesh, NodalLoad, Section, StaticCase
...
class FeaPage(QWidget):
    ...
    def current_material(self) -> LinearElastic:
        """当前参数对应的线弹性材料（平面应力）."""
        return LinearElastic(e_modulus=self._young_spin.value(), poisson=self._poisson_spin.value())
    ...
    def _on_finished(self, solution: StaticSolution) -> None:
        """渲染结果并更新摘要."""
